...
Last updated: 2026-04-22 after shipping #14 expense claims. **All must-haves shipped.** Ten should-haves (stock count, proforma invoices, recurring bills, recurring journals, number series, audit log, customer statement email, final settlement, landed cost, expense claims) now in the shipped list.
