      ...
      <header className="border-b border-white/10 bg-black/40 backdrop-blur">
        <div className="flex h-14 items-center justify-between px-6">
          ...
          <nav className="flex items-center gap-4 text-small text-white/80">
            ...
            <Link href="/platform/coupons" className="hover:text-white">
              Coupons
            </Link>
            <Link href="/platform/revenue" className="hover:text-white">
              Revenue
            </Link>
            <Link href="/platform/dunning" className="hover:text-white">
              Dunning
            </Link>
            {canImpersonate && (
