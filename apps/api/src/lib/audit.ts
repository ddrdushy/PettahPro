...
export type AuditEventKind =
  ...
  | "attendance_device.created"
  | "attendance_device.updated"
  | "attendance_device.deleted"
  ...
  | "attendance_record.muster"
  | "attendance_import.completed"
  | "attendance_import.failed"
  | "biometric_map.updated"
  // Settings
  | "settings.update"
